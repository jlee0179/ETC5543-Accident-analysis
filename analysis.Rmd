...
nswshifts_drvhour_rf <- rand_forest() %>%
  set_engine("randomForest",
             importance = TRUE, proximity = TRUE) %>%
  set_mode("classification") %>%
  fit(has_incident~drive_hour+start_hour+Gender, data = nswshifts_drvhour_tr)
...
nswshifts_drvhour_ts_pred <- nswshifts_drvhour_ts %>%
  mutate(.pred = predict(nswshifts_drvhour_rf, nswshifts_drvhour_ts)$.pred_class)
