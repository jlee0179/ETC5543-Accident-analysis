...
melbourneweather <- melbourneweather %>%
  ...
  rename(c(timestamp = location, `Melbourne Temperature` = Melbourne, `Melbourne Precipitation Total` = Melbourne_1, 
           `Melbourne Relative Humidity` = Melbourne_2, `Melbourne Wind Speed` = Melbourne_3, `Melbourne Wind Direction` = Melbourne_4, `Melbourne Cloud Cover Total` = Melbourne_5)) %>%
  select(timestamp, `Melbourne Temperature`, `Melbourne Precipitation Total`, `Melbourne Cloud Cover Total`)
melbourneweather <- melbourneweather %>%
